function [cellData,indF,indB,noiseCell1,noiseCell2,freqLabels,binLabels,chanIncluded] = textExportToRca(pathname, dataType, freqsToUse, binsToUse)
    ...
    for f = 1:length(filenames)
        ...
        if (isempty(binsToUse))
            binsToUse = 0:(numel(binLabelsCrnt) - 1); % load all bins
        end
